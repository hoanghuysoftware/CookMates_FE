                ...
                <tbody>
                    {recipes.map((recipe) => (
                        <tr key={recipe.id}>
                            ...
                            <td>{recipe.author}</td>
                            <td>
                                {recipe.status === "pending" && <span className="badge bg-warning">Chờ duyệt</span>}
                                {recipe.status === "approved" && <span className="badge bg-success">Đã duyệt</span>}
                                {recipe.status === "rejected" && <span className="badge bg-danger">Bị từ chối</span>}
                            </td>
                            <td>
